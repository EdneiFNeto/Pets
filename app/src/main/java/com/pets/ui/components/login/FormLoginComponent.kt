...
import com.pets.R
import com.pets.ui.components.global.TextFieldComponent
...
fun FormLoginComponent(
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = stringResource(R.string.label_pets),
                color = Color.Black,
                fontSize = 24.sp,
            ...
            Text(
                text = stringResource(R.string.label_app),
                color = Color.White,
                fontSize = 26.sp,
                fontFamily = robotoRegular
            )
        ...
        Button(
            ...
            onClick = {
                if (!isErrorEmail) {
                    handleEvent(LoginEvent.OnLogin(textEmail.value.text, navigate))
                } else {
                    isErrorEmail = true
                }
            }) {
            Text(text = stringResource(id = R.string.label_login), color = Color.White)
        }
    }
}
